...
export default function Page(){return <main className="site inner-page"><div className="glow hero-glow"/><div className="glow top-glow"/><Header active=""/><BackSection href="/" label="Back to Home" context="VYRON account access"/><section className="form-page"><div><div className="pill">CLIENT PORTAL</div><h1>VYRON<br/><span>Client Portal.</span></h1><p>A future secure area where VYRON clients will access their products, dashboards, demos and account tools.</p><div className="contact-lines"><span><Mail/>info@vyronsoft</span><span><Phone/>072 080 4844</span></div></div><form className="lead-form page-form"><input placeholder="Email address"/><input placeholder="Password" type="password"/><button>Continue</button><a href="/contact">Need access? Contact VYRON</a></form></section></main>}
